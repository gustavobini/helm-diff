# Helm Diff Plugin
[![Go Report Card](https://goreportcard.com/badge/github.com/gustavobini/helm-diff)](https://goreportcard.com/report/github.com/gustavobini/helm-diff)
[![GoDoc](https://godoc.org/github.com/gustavobini/helm-diff?status.svg)](https://godoc.org/github.com/gustavobini/helm-diff)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com/gustavobini/helm-diff/blob/master/LICENSE)
...
```shell
helm plugin install https://github.com/gustavobini/helm-diff
```

### Pre Helm 2.3.0 Installation
Pick a release tarball from the [releases](https://github.com/gustavobini/helm-diff/releases) page.
...
Examples:
  ...
  # See https://github.com/gustavobini/helm-diff/issues/278 for more information.
  ...
  # See https://github.com/gustavobini/helm-diff/issues/253 for more information.
...
```
$ mkdir -p $GOPATH/src/github.com/gustavobini/
$ cd $GOPATH/src/github.com/gustavobini/
$ git clone https://github.com/gustavobini/helm-diff.git
$ cd helm-diff
$ make install
```
